...
variable "github_oauth_token_ssm_path" {
  description = "SSM path for GitHub OAuth token"
  type        = string
}
...
resource "aws_codebuild_project" "frontend" {
  name         = "${var.codebuild_project_name}-frontend"
...
resource "aws_codebuild_project" "backend" {
  name         = "${var.codebuild_project_name}-backend"
  service_role = aws_iam_role.codebuild.arn
  ...
  tags = {
    Name = "${var.project_name}-codebuild-backend"
  }
}

# Get GitHub OAuth token from SSM
data "aws_ssm_parameter" "github_token" {
  name            = var.github_oauth_token_ssm_path
